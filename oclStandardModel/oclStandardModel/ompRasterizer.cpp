...
float OMP_Rasterizer::determinant(const SMatrix matrix, int size) {
	if (size == 1) {
		return matrix[0][0];
	}
	else if (size == 2) {
...
void OMP_Rasterizer::triangleFaceOrientation(const SMatrix points, const int rank,
...
void OMP_Rasterizer::echelonTest(int* ranks, int* indCols) {
